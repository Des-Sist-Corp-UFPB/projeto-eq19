...
A migração incremental foi concluída na V14. PostgreSQL relacional é a fonte de verdade de usuários, autenticação, perfis, jogos, favoritos, eventos, partidas, comentários e auditoria.
