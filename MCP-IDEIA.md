# Ideia de Servidor MCP — EQ19

**Domínio:** Comunidade de jogos de mesa (acervo, eventos)  
**Data:** 2026-07-01
...
## Servidor proposto: `tabula-mcp`

### Tools sugeridas

- `buscar_jogo(nome)` — busca no acervo
- `sugerir_jogo(n_jogadores, duracao)` — recomenda por critério
- `marcar_evento(jogoId, data, local)` — cria evento
- `acervo_usuario(userId)` — jogos do usuário

### Resources (somente leitura)

- acervo e agenda de eventos como resource

### Exemplos de uso com um LLM

- "Somos 5 pessoas e temos 1 hora — sugira um jogo e marque para sábado."
...
public class TabulaTools {
    ...
    public TabulaTools(SeuService seuService) { this.seuService = seuService; }

    @Tool(description = "busca no acervo")
    public Object buscar_jogo(/* params */) {
